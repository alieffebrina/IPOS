              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="input-group">
                      <input type="text" class="form-control" id="qtt" name="qtt" value="" onkeyup='Calculate()'>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10" id="nama">
                    <input type="text" class="form-control" name="diskon" id="diskon" onkeyup='Calculate()'>
                ...
                <div class="form-group">
                  ...
                  <!-- <a class=""> -->
                  <button class="btn btn-primary" id="butsend">add data</button>
                </div>
              </div>
              <!-- /.box-body -->
              <!-- /.box-footer -->
          ...
          <div class="box box-danger">
            <div class="col-xs-12">
              ...
              <h3 class="text-muted well well-sm no-shadow" id="terbilang" style="text-align: center;"></h3>
                ...
                <button class="btn btn-info pull-right">Cetak Nota</button>
            </div>
            ...
            <div class="col-xs-18">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control"  name="subtotalbawah" id="subtotalbawah" readonly value="0">
                  </div>
                </div>
                <div class="form-group">
