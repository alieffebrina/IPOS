            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <!--<tr>-->
                  ...
                  <td><?php echo $value_penjualan->tglnota;?></td>
                  ...
                  <td><?php echo $value_penjualan->pembayaran; ?></td>
            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                <!--<tr>-->
                  ...
                  <td><?php echo $value_detail_penjualan->tglnota;?></td>
                  <td><?php echo $value_detail_penjualan->barang;?></td>
                  <td><?php echo $value_detail_penjualan->jenisbarang;?></td>
