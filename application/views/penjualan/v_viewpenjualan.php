  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('C_penjualan'); ?>">Transaksi Penjualan</a></li>
        <li class="active"><a href="<?php echo site_url('C_penjualan'); ?>">Lihat Transaksi Penjualan</a></li>
      </ol>
    </section>
<!-- Main content -->
            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="radio" name="pembayaran" <?php if($key->pembayaran == "cash"){ echo 'checked="checked"'; }?> disabled> Cash
                  <input type="radio" name="pembayaran" <?php if($key->pembayaran == "kredit"){ echo 'checked="checked"'; }?> disabled> Kredit
                  </div>
                </div>
                <div class="form-group">
