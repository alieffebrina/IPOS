            ...
            <form class="form-horizontal" method="POST" action="<?php echo site_url('C_jenisbarang/editjenisbarang')?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="jenisbarang" name="jenisbarang" value="<?php echo $jenisbarang->jenisbarang ?>">
                    <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $jenisbarang->id_jenisbarang ?>">
                  </div>
                </div>
              </div>
              <?php } ?>
              ...
              <div class="box-footer">
                  <div class="col-sm-10">
                    <a href="<?php echo site_url('C_jenisbarang/add'); ?>" class="btn btn-default">Batal</a>
