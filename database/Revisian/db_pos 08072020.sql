...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2020 at 05:22 PM
...
CREATE TABLE `tb_barang` (
  ...
  `stokmin` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `tb_barang` (`id_barang`, `barang`, `id_satuan`, `id_jenisbarang`, `nourut`, `tgl_update`, `stok`, `stokmin`, `hargabeli`, `id_user`) VALUES
('2020-07-05-a-', 'barangaa', 2, 1, 4, '2020-07-05', 0, 0, '', NULL),
('2020-07-05-a-5', 'brang', 2, 1, 5, '2020-07-05', 0, 0, '', NULL),
('tanggal-b-2', 'arang', 2, 1, 2, '2020-07-05', 0, 0, '', NULL),
('tanggal-b-3', 'barang3', 2, 1, 3, '2020-07-05', 0, 0, '', NULL);
...
(3, 1, 'Data Jenis Pembayaran', '', 'tidak'),
...
(10, 2, 'Transaksi Penjualan', '', 'aktif'),
(11, 2, 'Surat Jalan', '', 'aktif'),
(12, 2, 'Invoice', '', 'tidak'),
(13, 2, 'Retur', '', 'aktif'),
(14, 3, 'Transaksi Pembelian', '', 'aktif'),
...
(1, 'suplier', 'asd', '1304', '13', '131', '0000-00-00', 'asd', 2147483647, '1sad');
...
CREATE TABLE `tb_suratjalan` (
  `id_suratjalan` varchar(15) NOT NULL,
  `id_penjualan` varchar(15) NOT NULL,
