...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2020 at 10:17 PM
...
('2020-07-14-a-2', 2, 'Paving 1', 1, 4, 10, 20, 60000, 3, '2020-07-14', 8, 430);
...
(1, 'barang', 'tanggal-a-no'),
(2, 'penjualan', 'INV.tanggal.no'),
(3, 'suratjalan', 'SJ.tanggal.no'),
(4, 'returpenjualan', 'RPJ.tanggal.no');
...
CREATE TABLE `tb_stokopname` (
  ...
  `jumlahretur` int(11) DEFAULT NULL,
  `status` int(11) NOT NULL,
