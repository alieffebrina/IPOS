...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Jul 2020 pada 18.55
...
('B.2020-07-31.1', 15, 'Paving  6 Cm', 1, 4, 8, 0.023255813953488, 9, 48000, 3, '2020-07-31', 8, 344),
...
('B.2020-07-31.17', 31, 'Kasntin', 2, 11, 10, 0, 9, 16000, 3, '2020-07-31', 8, 10),
...
('B.2020-07-31.3', 17, 'Paving  6 Cm', 1, 6, 10, 0, 9, 55000, 3, '2020-07-31', 8, 430),
('B.2020-07-31.4', 18, 'Paving  6 Cm', 1, 8, 10, 0, 9, 65000, 3, '2020-07-31', 8, 430),
('B.2020-07-31.5', 19, 'Paving  6 Cm', 1, 9, 10, 0, 9, 70000, 3, '2020-07-31', 8, 430),
('B.2020-07-31.6', 20, 'Paving  8 Cm', 1, 5, 10, 0, 9, 58000, 3, '2020-07-31', 8, 430),
('B.2020-07-31.7', 21, 'Paving 8 Cm', 1, 6, 10, 0, 9, 63000, 3, '2020-07-31', 8, 430),
...
--
-- Struktur dari tabel `tb_detailreturpenjualan`
--
...
--
-- Dumping data untuk tabel `tb_detailreturpenjualan`
--
...
(4, 'RIZKY FEBRIANTO', 'WRINGIN KURUNGJAYA RT 05 RW 04', '35', '3525', '081216590250', 5500000, '2020-07-31', 8);
...
--
-- Dumping data untuk tabel `tb_suratjalan`
--
...
--
-- Indeks untuk tabel `tb_detailreturpenjualan`
--
...
--
-- Indeks untuk tabel `tb_mutasibarang`
--
...
--
-- AUTO_INCREMENT untuk tabel `tb_detailreturpenjualan`
--
ALTER TABLE `tb_detailreturpenjualan`
...
--
-- AUTO_INCREMENT untuk tabel `tb_mutasibarang`
--
ALTER TABLE `tb_mutasibarang`
