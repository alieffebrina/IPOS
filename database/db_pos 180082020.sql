...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2020 at 12:31 PM
...
('B.2020-07-31.1', 15, 'Paving  6 Cm', 1, 4, 3, 0.023255813953488, 9, 48000, 3, '2020-07-31', 8, 344),
...
('B.2020-07-31.15', 29, 'Topy Uskup 8 Cm', 2, 7, 8, 0, 9, 3087, 3, '2020-07-31', 8, 10),
('B.2020-07-31.16', 30, 'Kasntin', 2, 10, 9, 0, 9, 9500, 3, '2020-07-31', 8, 10),
('B.2020-07-31.17', 31, 'Kasntin', 2, 11, 4, 0, 9, 16000, 3, '2020-07-31', 8, 10),
('B.2020-07-31.18', 32, 'Kasntin', 2, 12, -6.7674418604651, 0, 9, 21000, 3, '2020-07-31', 8, 53),
('B.2020-07-31.2', 16, 'Paving  6 Cm', 1, 5, 9.93023255814, 7, 9, 50000, 3, '2020-07-31', 8, 556),
...
('B.2020-07-31.5', 19, 'Paving  6 Cm', 1, 9, 9, 0, 9, 70000, 3, '2020-07-31', 8, 430),
...
('B.2020-07-31.8', 22, 'Paving 8 Cm', 1, 7, 8, 0, 9, 70000, 3, '2020-07-31', 8, 430),
('B.2020-07-31.9', 23, 'Topy Uskup 6 Cm', 2, 5, 6, 0, 9, 2217, 3, '2020-07-31', 8, 10);
...
(5, 'pembelian', 'username.no.PBL.tanggal'),
(6, 'penjualan', 'username.no.INV.tanggal'),
(7, 'returpenjualan', 'username.no.RPJ.tanggal'),
(8, 'suratjalan', 'username.no.SJ.tanggal'),
(9, 'barang', 'username.no.B.tanggal'),
(10, 'Retur Pembelian', 'username.no.RP.tanggal');
...
CREATE TABLE `tb_suratjalan` (
  ...
  `id_user` int(11) DEFAULT NULL,
  `status` int(11) NOT NULL,
  `alamatkirim` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `tb_detailpenjualan`
  MODIFY `id_detailpenjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
